...
#     rescue_from BadRequestError, with: :standardize_bad_request_error_response
...
#     rescue_from UnauthenticatedError, with: :standardize_unauthenticated_error_response
